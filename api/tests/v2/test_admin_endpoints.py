...
class TestEndpoints(unittest.TestCase):
    ...
    def login_test_admin(self):
        ...
        auth_token = helper_functions.response_as_json(resp)['admin']['auth_token']
        return auth_token
    ...
    #     response = self.client.   # def test_unauthorized_admin_get_all(self):
    #     """
    #         1. Test that an unauthorised admin cannot get all orders
    #         by all users
    #     """
    ...
    #         self.food["food_item_name"])put("{}/orders/1".format(
    #         self.base_url), json={
    #             "order_status": "completed"
    #         }, headers={
    #             "Content-Type": "application/json", "Authorization": adm_token})
